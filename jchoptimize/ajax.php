...
class JchOptimizeAjax
{
        ...
        public static function optimizeImages(JchPlatformSettings $params)
        {
                ...
                $arr   = array('done' => 0, 'total' => 0, 'current' => 0, 'optimize' => 0);
                ...
                JchOptimizeHelper::postStatus($arr);
                ...
                foreach ($files as $file)
                {
                        ...
                        try
                        {
                                ...
                                $smushit      = new $smushitclass($file, 0x02);
                        ...
                        JchOptimizeHelper::postStatus($arr, TRUE, $optimized);
                }
